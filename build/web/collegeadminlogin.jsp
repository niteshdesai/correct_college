<%-- 
    Document   : collegeadminlogin
    Created on : 09-Jan-2024, 4:33:52 pm
    Author     : admin
--%>
    ...
    <body>
        ...
        <div class="container my-contain login-form d-flex flex-column">
            <div class="col-12 col-sm-8 col-md-8 col-lg-4  offset-sm-2 offset-md-2 offset-lg-4 p-4" style="background-color: rgb(231, 231, 231);box-shadow: -2px 5px 11px -4px rgba(0,0,0,0.75);
                ...
                <div class="row">
            <%
             message mg = (message) session.getAttribute("collegeadminmsg");
             if(mg!=null)
             {
            %>
            ...
            <% session.setAttribute("collegeadminmsg",null);} %>
                </div>
                <div class="row">
                    <div class="col-12 col-md-12 ">
                        <form action="collegeadminlogin" method="post" onsubmit="return match()">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type=password class="form-control" id="enrollment"  name="password" required>
                            </div>
